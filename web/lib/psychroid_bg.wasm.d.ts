...
export const specificEnthalpyLine: (a: number, b: number, c: number, d: number, e: number) => [number, number];
...
export const wasmmoistair_humidifyIsothermal: (a: number, b: number, c: number) => void;
